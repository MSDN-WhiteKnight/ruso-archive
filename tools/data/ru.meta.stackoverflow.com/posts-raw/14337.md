...
se.link: "https://ru.meta.stackoverflow.com/a/14337"
se.post_id: 14337
se.post_type: answer
---
<p>Готово!</p>
<pre><code>updating post history, 27 rows affected (pipe delimited)
updating posts, 26 rows affected  (pipe delimited)
updating PostTags associations, 24 rows affected
updating ForYou nudges, 0 rows affected
destroying 'domain': [domain] removed from (0 post, 0 history, 1 tag)
...
updating count for target tag, new count: 213
tag remapping of [домен] and [domain] complete!
remapping 0 synonyms
0 favorite and ignored tags remapped!
0 tracked tag badges were remapped!
Tag Synonym domain -&gt; домен was approved!
</code></pre>
